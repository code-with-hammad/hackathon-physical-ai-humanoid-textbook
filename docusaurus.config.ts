...
const config: Config = {
  ...
  tagline: 'Physical AI & Humanoid Robotics with Integrated RAG Chatbot',
  ...
  url: 'https://hackathon-physical-ai-humanoid-textbook-kwccwwddx.vercel.app/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        ...
        src: 'img/robotic image.webp',
      },
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'ros2NervousSystemSidebar',
          position: 'left',
